...
(function (global, factory) {
    ...
    methodsToPatch.forEach(function (method) {
        ...
        def(arrayMethods, method, function mutator() {
            ...
            {
                ob.dep.notify({
                    type: "array mutation" /* TriggerOpTypes.ARRAY_MUTATION */, target: this, key: method
                });
            }
            return result;
        });
    ...
    // ssr mock dep
    var mockDep = {
        notify: noop, depend: noop, addSub: noop, removeSub: noop
    };
    /**
        ...
        Object.defineProperty(obj, key, {
            enumerable: true, configurable: true, get: function reactiveGetter() {
                ...
                if (Dep.target) {
                    {
                        dep.depend({
                            target: obj, type: "get" /* TrackOpTypes.GET */, key: key
                        });
                    }
                    if (childOb) {
                        childOb.dep.depend();
                ...
                {
                    dep.notify({
                        type: "set" /* TriggerOpTypes.SET */, target: obj, key: key, newValue: newVal, oldValue: value
                    });
                }
            }
        });
    ...
    function set(target, key, val) {
        ...
        {
            ob.dep.notify({
                type: "add" /* TriggerOpTypes.ADD */, target: target, key: key, newValue: val, oldValue: undefined
            });
        }
        return val;
    }
    ...
    function del(target, key) {
        ...
        {
            ob.dep.notify({
                type: "delete" /* TriggerOpTypes.DELETE */, target: target, key: key
            });
        }
    }
    ...
    function triggerRef(ref) {
        ...
        }
        {
            ref.dep && ref.dep.notify({
                type: "set" /* TriggerOpTypes.SET */, target: ref, key: 'value'
            });
        }
    }
    ...
    function customRef(factory) {
        ...
        var _a = factory(function () {
            {
                dep.depend({
                    target: ref, type: "get" /* TrackOpTypes.GET */, key: 'value'
                });
            }
        }, function () {
            {
                dep.notify({
                    target: ref, type: "set" /* TriggerOpTypes.SET */, key: 'value'
                });
            }
                ...
                if (watcher) {
                    ...
                    if (Dep.target) {
                        if (Dep.target.onTrack) {
                            Dep.target.onTrack({
                                effect: Dep.target, target: ref, type: "get" /* TrackOpTypes.GET */, key: 'value'
                            });
                        }
                        watcher.depend();
                    }
    ...
    var normalizeEvent = cached(function (name) {
        ...
        return {
            name: name, once: once, capture: capture, passive: passive
        };
    });
    ...
    function normalizeScopedSlot(vm, normalSlots, key, fn) {
        ...
        if (fn.proxy) {
            Object.defineProperty(normalSlots, key, {
                get: normalized, enumerable: true, configurable: true
            });
        }
        return normalized;
    }
    ...
    function createSetupContext(vm) {
        ...
        return {
            ...
            }, emit: bind$1(vm.$emit, vm), expose: function (exposed) {
                {
                    if (exposeCalled) {
    ...
    function defineAsyncComponent(source) {
        ...
        return function () {
            var component = load();
            return {
                component: component, delay: delay, timeout: timeout, error: errorComponent, loading: loadingComponent
            };
        };
    }
        ...
        return function computedGetter() {
            ...
            if (watcher) {
                ...
                if (Dep.target) {
                    if (Dep.target.onTrack) {
                        Dep.target.onTrack({
                            effect: Dep.target, target: this, type: "get" /* TrackOpTypes.GET */, key: key
                        });
                    }
                    watcher.depend();
                }
    ...
    function createComponentInstanceForVnode(// we know it's MountedComponentVNode but flow doesn't
        ...
        parent) {
        var options = {
            _isComponent: true, _parentVnode: vnode, parent: parent
        };
    ...
    function assertType(value, type, vm) {
        ...
        return {
            valid: valid, expectedType: expectedType
        };
    }
        ...
        name: 'keep-alive', abstract: true, props: {
            ...
            cacheVNode: function () {
                ...
                if (vnodeToCache) {
                    ...
                    cache[keyToCache] = {
                        name: _getComponentName(componentOptions), tag: tag, componentInstance: componentInstance
                    };
    ...
    function initGlobalAPI(Vue) {
        ...
        Vue.util = {
            warn: warn$2, extend: extend, mergeOptions: mergeOptions, defineReactive: defineReactive
        };
        Vue.set = set;
        Vue.delete = del;
    ...
    function addDirective(el, name, rawName, value, arg, isDynamicArg, modifiers, range) {
        (el.directives || (el.directives = [])).push(rangeSetItem({
            name: name, rawName: rawName, value: value, arg: arg, isDynamicArg: isDynamicArg, modifiers: modifiers
        }, range));
        el.plain = false;
    }
    ...
    function parseModel(val) {
        ...
        if (val.indexOf('[') < 0 || val.lastIndexOf(']') < len - 1) {
            ...
            if (index > -1) {
                return {
                    exp: val.slice(0, index), key: '"' + val.slice(index + 1) + '"'
                };
            } else {
                return {
                    exp: val, key: null
        ...
        return {
            exp: val.slice(0, expressionPos), key: val.slice(expressionPos + 1, expressionEndPos)
        };
    }
    ...
    var events = {
        create: updateDOMListeners, update: updateDOMListeners, // @ts-expect-error emptyNode has actually data
        destroy: function (vnode) {
    ...
    var domProps = {
        create: updateDOMProps, update: updateDOMProps
    };
    ...
    var style$1 = {
        create: updateStyle, update: updateStyle
    };
    ...
    var transition = inBrowser ? {
        create: _enter, activate: _enter, remove: function (vnode, rm) {
            /* istanbul ignore else */
            if (vnode.data.show !== true) {
                // @ts-expect-error
                leave(vnode, rm);
    ...
    function actuallySetSelected(el, binding, vm) {
        ...
        if (isMultiple && !Array.isArray(value)) {
            warn$2("<select multiple v-model=\"".concat(binding.expression, "\"> ") + "expects an Array value for its binding, but got ".concat(Object.prototype.toString
                .call(value)
                .slice(8, -1)), vm);
            return;
        }
    ...
    var Transition = {
        name: 'transition', props: transitionProps, abstract: true, render: function (h) {
            var _this = this;
    ...
    delete props.mode;
    var TransitionGroup = {
        props: props, beforeMount: function () {
            var _this = this;
    ...
    var platformComponents = {
        Transition: Transition, TransitionGroup: TransitionGroup
    };
    ...
    var klass = {
        staticKeys: ['staticClass'], transformNode: transformNode$1, genData: genData$2
    };
    ...
    var style = {
        staticKeys: ['staticStyle'], transformNode: transformNode, genData: genData$1
    };
    ...
    function parse(template, options) {
        ...
        parseHTML(template, {
            ...
            chars: function (text, start, end) {
                ...
                if (text) {
                    ...
                    if (!inVPre && text !== ' ' && (res = parseText(text, delimiters))) {
                        child = {
                            type: 2, expression: res.expression, tokens: res.tokens, text: text
                        };
            ...
            comment: function (text, start, end) {
                ...
                if (currentParent) {
                    var child = {
                        type: 3, text: text, isComment: true
                    };
                    if (options.outputSourceRange) {
                        child.start = start;
                        child.end = end;
    ...
    function processRawAttrs(el) {
        ...
        if (len) {
            ...
            for (var i = 0; i < len; i++) {
                attrs[i] = {
                    name: list[i].name, value: JSON.stringify(list[i].value)
                };
    ...
    function preTransformNode(el, options) {
        if (el.tag === 'input') {
            ...
            if (typeBinding) {
                ...
                addIfCondition(branch0, {
                    exp: "(".concat(typeBinding, ")==='radio'") + ifConditionExtra, block: branch1
                });
                // 3. other
    ...
    var directives = {
        model: model$1, text: text, html: html
    };
    ...
    function generate(ast, options) {
        ...
        return {
            render: "with(this){return ".concat(code, "}"), staticRenderFns: state.staticRenderFns
        };
    }
    ...
    function genSlot(el, state) {
        ...
        var attrs = el.attrs || el.dynamicAttrs ? genProps((el.attrs || []).concat(el.dynamicAttrs || []).map(function (attr) {
            return ({
                ...
                name: camelize(attr.name), value: attr.value, dynamic: attr.dynamic
            });
        })) : null;
    ...
    var prohibitedKeywordRE = new RegExp('\\b' + ('do,if,for,let,new,try,var,case,else,with,await,break,catch,class,const,' + 'super,throw,while,yield,delete,export,import,return,switch,default,' + 'extends,finally,continue,debugger,function,arguments')
        .split(',')
        .join('\\b|\\b') + '\\b');
    ...
    function createCompilerCreator(baseCompile) {
        return function createCompiler(baseOptions) {
            ...
            return {
                compile: compile, compileToFunctions: createCompileToFunctionFn(compile)
            };
        };
    }
